...
export const SearchBar = () => {
    ...
    const onBaseAssetChange = (event: SyntheticEvent, value: string | null) => {
        value && dispatch({type: QuoteActionTypes.SET_BASE_ASSET, payload: value});
    }

    const onQuoteAssetChange = (event: SyntheticEvent, value: string | null) => {
        value && dispatch({type: QuoteActionTypes.SET_QUOTE_ASSET, payload: value});
    }

    const onAssetPairChange = (event: SyntheticEvent, value: string | null) => {
        value && dispatch({type: QuoteActionTypes.SET_ASSET_PAIR, payload: value});
    }
